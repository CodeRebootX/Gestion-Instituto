 ...
 * @author estudiante
 */
public class InsertarAsignatura extends javax.swing.JDialog {

    /**
     * Creates new form InsertarAsignatura
     */
    public InsertarAsignatura(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabelTitulo.setText("NUEVA ASIGNATURA");
        getContentPane().add(jLabelTitulo);
        jLabelTitulo.setBounds(170, 20, 140, 18);
        ...
        jPanel1.setBounds(49, 109, 400, 100);
        ...
        jButtonAgregar.setBounds(220, 310, 110, 30);
    ...
    private void jButtonAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAgregarActionPerformed
        ...
        Asignatura asignatura = new Asignatura (codigo, nombre, horas);
        ...
        try { 
            ...
            Logger.getLogger(InsertarAsignatura.class.getName()).log(Level.SEVERE, null, ex);
        }
        dispose(); 
