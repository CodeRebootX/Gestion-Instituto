...
public class ModificarAlumnos extends javax.swing.JFrame {
    ...
    public ModificarAlumnos(Alumno alumno) {
        initComponents();
        this.setLocationRelativeTo(null);
        setLabelImage();
        jLabelId.setText(String.valueOf(alumno.getId()));
        jTextFieldDni.setText(alumno.getDni());
        jTextFieldNombre.setText(alumno.getNombre());
        jTextFieldApellido.setText(alumno.getApellido());
        jTextFieldNacimiento.setText(alumno.getNacimiento());
        jTextFieldCodPostal.setText(String.valueOf(alumno.getCod_postal()));
        jTextFieldTelefono.setText(String.valueOf(alumno.getTelefono()));
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(200, 10, 108, 18);
        ...
        jPanel2.setBounds(59, 42, 390, 240);
        ...
        jButtonUpdate.setBounds(200, 320, 110, 30);
    ...
    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        ...
        try {
            ...
            Logger.getLogger(ModificarAlumnos.class.getName()).log(Level.SEVERE, null, ex);
        }
        dispose();
